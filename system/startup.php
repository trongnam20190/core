...
function modification($filename) {
	if (!defined('DIR_ROOT')) {
		$file = DIR_MODIFICATION . 'app/' . substr($filename, strlen(DIR_ROOT));
	} else {
		$file = DIR_MODIFICATION . 'admin/' .  substr($filename, strlen(DIR_ROOT));
	}
...
require_once(modification(DIR_SYSTEM . 'vendor/tlslib/src/Tls.php'));
